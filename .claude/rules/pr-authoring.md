...
| Facet                                 | Rule                                                                                                                                                                                                                                                                      |
| ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Type**                              | One of `feat` / `fix` / `docs` / `style` / `refactor` / `test` / `chore`. `feat` for new runtime capability; `refactor` for structural moves with no behaviour change; `test` for test-only changes; `docs` for ADR/doc-only; `chore` for tooling, deps, and scaffolding. |
