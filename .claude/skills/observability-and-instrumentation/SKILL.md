...
- Launch-day monitoring checklists and rollback triggers — out of scope for this skill, which covers the instrumentation that feeds them
...
For the at-a-glance version of this list, including the pre-launch instrumentation gate, see [`../../references/observability-checklist.md`](../../references/observability-checklist.md).
