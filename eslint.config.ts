...
export default defineConfig([
  globalIgnores([
    ...
    "app/dist",
    "app/logs",
    "app/shared/types/generated/db/database.type.ts",
  ]),
  {
    extends: [
  ...
  // Config files and entry points: allow default exports
  {
    files: [
      "**/*.config.ts",
      "**/*.d.ts",
      "app/client/entry.server.tsx",
      "app/client/layouts/**/index.ts",
      "app/client/pages/**/index.ts",
      "app/client/root.tsx",
  ...
  // Client files: enable restricted imports
  {
    ...
    ignores: ["app/client/routes.ts", "app/client/routes/**/*.ts"],
    rules: {
