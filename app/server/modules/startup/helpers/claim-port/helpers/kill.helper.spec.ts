...
const { lookupPort, ...TEST_DATA } = {
  ...
  NO_PID: "no-pid",
  PORT_KILL_THREW: castAsType<Port>(VALID_PORT_1 + 1),
  PORT_LOOKUP_THREW: castAsType<Port>(VALID_PORT_1 + 4),
  PORT_NAN_PID: castAsType<Port>(VALID_PORT_1 + 2),
  PORT_NEGATIVE_PID: castAsType<Port>(VALID_PORT_1 + 3),
  PORT_OK: castAsType<Port>(VALID_PORT_1),
  PORT_SELF_PID: castAsType<Port>(VALID_PORT_1 + 5),
  PORT_SELF_PPID: castAsType<Port>(VALID_PORT_1 + 6),
  SELF_PID: "self-pid",
  get FAILURE_CASES() {
    return castAsType<
      Array<{
